    ...
    if ($stmt === false) {
      ...
      if ($stmt->execute()) {
        ...
        if ($equipo_data) {
          ...
          auditar("El/la docente reportó un fallo para el equipo ID {$id_equipo} ({$equipo_desc}). {$reporte_desc}", 'reporte');
        }
  ...
  <div class="container">
    <div class="card">
      ...
      <?php if ($ok): ?>
        ...
        <div class="muted"><a href="/prestar_UC/public/docentes/docente_panel.php">Volver al inicio</a></div>
      <?php else: ?>
