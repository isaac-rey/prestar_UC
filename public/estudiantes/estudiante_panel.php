          ...
          <tbody>
            ...
            <?php else: foreach ($activos as $p): ?>
              <tr>
                ...
                <td>
                  <a href="/prestar_uc/public/estudiantes/estudiante_equipo.php?serial=<?=urlencode($p['serial_interno'])?>">
                ...
                <td>
                  <a class="btn" href="/prestar_uc/public/estudiantes/estudiante_equipo.php?serial=<?=urlencode($p['serial_interno'])?>">
                    Ver / Devolver
                  </a>
                </td>
              </tr>
